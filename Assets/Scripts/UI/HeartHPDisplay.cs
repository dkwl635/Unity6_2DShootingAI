...
namespace ShooterGame.UI
{
    public class HeartHPDisplay : MonoBehaviour
    {
        ...
        [SerializeField] private Transform   _container;       // HorizontalLayoutGroup parent
        ...
        private void Start()
        {
            ...
            _playerStats.OnHit       += OnHit;

            BuildHearts(_playerStats.MaxHp);
            Refresh(_playerStats.CurrentHp, _playerStats.MaxHp);
        }
